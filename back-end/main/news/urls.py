...
urlpatterns = [
    path('Get_top_news/',views.Get_Top_News.as_view(),name='top_news'),
    ...
    path('Get_top_news_in_Competition/<int:competition_id>/',views.Get_top_news_in_Competition.as_view(),name="top news in ccompetition")
]
if settings.DEBUG:

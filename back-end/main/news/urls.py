...
urlpatterns = [
    ...
    path('Get_News/<int:id>/',views.Get_News.as_view(),name='Get'),
    ...
    path('Get_news_from_competitions/<str:competition>/',views.Get_news_from_competitions.as_view(),name='Get news competitions'),
